...
public class Main {
    public static void main(String[] args) {
        ...
        if (cinema.checkHour(open, 1) && cinema.checkHour(close, 1)) {
                ...
                try {
                    ...
                    switch (sc.next()) {
                        ...
                        case "3":
                            ...
                            boolean checkHourStart = cinema.checkHour(startHour, 1);
                            boolean checkMinStart = cinema.checkHour(1, startMin);
                            System.out.println("Please enter day");
                            String dayStart = sc.next();
                            if (checkHourStart && checkMinStart) {
                                Seance seance = new Seance(cinema.getMoviesLibrary().get(idMov), new Time(startHour, startMin));
                                cinema.addSeance(seance, dayStart);
                            } else System.out.println("Please retry enter Hour and Min start movie");
                            break;
                        case "4":
            ...
            System.out.println("Please retry entry clock(hour)");
        }
